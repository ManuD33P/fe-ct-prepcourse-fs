...
function operadoresLogicos(num1, num2, num3) {
   ...
   // Primero Si alguno de los tres números es negativo, retornar ---> "Hay negativos".
   // Si num3 es más grande que num1 y num2, aumentar su valor en 1 y retornar el nuevo valor.
   // Ultimo Si todos los argumentos son cero, retornar ---> "Error".
...
function tieneTresDigitos(num) {
   ...
   // Tu código:
   return num >99 && num < 1000|| num < -99 && num > -1000? true : false 
}
